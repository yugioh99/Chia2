...
document.getElementById("fontArial").addEventListener("click", () => changeFont("Arial"));
document.getElementById("fontTimes").addEventListener("click", () => changeFont("Times New Roman"));
